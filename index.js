...
function showRepositories(event, data){
  ...
  console.log(repos);
  const respoList = `<ul>${repos.map(r => "<li>" + r.name + "</li>").join("")}
  </ul>`;
...
function showRepositories(event, data){
  ...
  "<li>" + r.name + ' - <a href="#" data-repo="' + r.name + '" onclick="getCommits(this)">Get Commits</a></li>').join("")}`
}
...
function showCommits(){
  ...
  "<li><strong" + commit.commit.author.name + "</strong> - " +
